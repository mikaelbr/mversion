...
describe('mversion(npm-shrinkwrap.json)', function () {

  var filename = '/tests/fixtures/npm-shrinkwrap/npm-shrinkwrap.json';
  ...
  describe('#Get()', function(){
    it('should return correct version from npm-shrinkwrap.json', function (done) {
